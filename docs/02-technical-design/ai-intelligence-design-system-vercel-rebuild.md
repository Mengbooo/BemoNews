---
doc_id: technical-design-ai-intelligence-design-system-vercel-rebuild
title: AI Intelligence 设计规范（Vercel 风格 · 可复刻版）
...
summary: 面向设计复刻与前端实现的高保真规范，细化了页面信息架构、区块顺序、断点和复刻级布局规则。
---
